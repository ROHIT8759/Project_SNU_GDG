  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-16" ref={contentRef}>
        <h1 className="text-4xl font-bold mb-8 text-center text-blue-600 scroll-item opacity-0">About</h1>

        <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md scroll-item opacity-0">
          ...
          <h4 className="text-xl font-semibold mb-2 text-blue-600">Why It Matters?</h4>
          <p className="mb-6 text-gray-700">
          ...
          <h4 className="text-xl font-semibold mb-2 text-blue-600">What Can We Do?</h4>
        ...
        <div className="max-w-3xl mx-auto mt-12 scroll-item opacity-0">
